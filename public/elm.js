...
var $author$project$Main$init = function (windowSize) {
	return _Utils_Tuple2(
		{
			source: $krisajenkins$remotedata$RemoteData$Loading,
			timeline: $mdgriffith$elm_animator$Animator$init(_Utils_Tuple0),
			windowSize: windowSize
		},
		$elm$http$Http$get(
			{
				expect: $elm$http$Http$expectString(
					A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotArticle)),
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A3($mdgriffith$elm_animator$Animator$toSubscription, $author$project$Main$AnimationTick, model, $author$project$Main$animator),
...
var $author$project$Resources$Font$baseFont = _List_fromArray(
	[
...
var $author$project$Resources$Font$scaled = function (i) {
	return $elm$core$Basics$round(
		A3($mdgriffith$elm_ui$Element$modular, 20, 1.5, i));
};
var $author$project$Resources$Font$bodyFontSize = $author$project$Resources$Font$scaled(1);
...
var $author$project$Resources$Color$backgroundColor = A3($mdgriffith$elm_ui$Element$rgb255, 32, 30, 36);
var $author$project$Resources$Color$borderColor = A3($mdgriffith$elm_ui$Element$rgb255, 72, 70, 76);
...
var $author$project$Loader$defaultConfig = {
...
var $mdgriffith$elm_markup$Mark$text = function (view) {
	return $mdgriffith$elm_markup$Mark$textWith(
		{inlines: _List_Nil, replacements: $mdgriffith$elm_markup$Mark$commonReplacements, view: view});
};
var $author$project$Article$texts = $mdgriffith$elm_markup$Mark$text(
	F2(
		function (styles, string) {
			var styleList = A2(
				...
				function (_v0) {
					var condition = _v0.a;
					var style = _v0.b;
					return condition ? $elm$core$Maybe$Just(style) : $elm$core$Maybe$Nothing;
				},
				_List_fromArray(
					[
						_Utils_Tuple2(styles.bold, $mdgriffith$elm_ui$Element$Font$bold),
						_Utils_Tuple2(styles.italic, $mdgriffith$elm_ui$Element$Font$italic),
						_Utils_Tuple2(styles.strike, $mdgriffith$elm_ui$Element$Font$strike)
					]));
			return A2(
...
var $author$project$Resources$Font$headingFontSize = $author$project$Resources$Font$scaled(3);
...
var $author$project$Article$title = A3(
	...
	function (children) {
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$size($author$project$Resources$Font$headingFontSize),
					$mdgriffith$elm_ui$Element$spacing(20)
				]),
			children);
	},
	$author$project$Article$texts);
var $author$project$Article$document = A2(
	$mdgriffith$elm_markup$Mark$document,
	$elm$core$Basics$identity,
	$mdgriffith$elm_markup$Mark$manyOf(
		_List_fromArray(
			[
				$author$project$Article$title,
				A2(
...
var $author$project$Resources$Color$panelColor = A3($mdgriffith$elm_ui$Element$rgb255, 52, 50, 56);
...
var $mdgriffith$elm_animator$Animator$wrapToUnit = function (x) {
	return x - $elm$core$Basics$floor(x);
};
var $mdgriffith$elm_animator$Animator$shift = F2(
	function (x, osc) {
		if (osc.$ === 'Oscillator') {
			var pauses = osc.a;
			var fn = osc.b;
			return A2(
				...
				function (u) {
					return fn(
						$mdgriffith$elm_animator$Animator$wrapToUnit(u + x));
				});
		} else {
			return osc;
		}
...
var $author$project$Loader$view = F2(
	function (config, timeline) {
		var paddingValue = 5;
		var maxBarHeight = config.size - (paddingValue * 2);
		var barsCount = 3;
				...
				A2(
					...
					function (_v0) {
						return A2(
							...
							A2(
								$mdgriffith$elm_animator$Animator$shift,
								i / barsCount,
								A2($mdgriffith$elm_animator$Animator$wave, 0.5, 1)));
					}) * maxBarHeight);
		};
		var bar = function (i) {
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$px(
							animateHeight(i))),
						$mdgriffith$elm_ui$Element$Background$color(config.color),
		...
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width(
					$mdgriffith$elm_ui$Element$px(config.size)),
					$mdgriffith$elm_ui$Element$height(
					$mdgriffith$elm_ui$Element$px(config.size)),
			...
			A2(
				$elm$core$List$map,
				bar,
				A2($elm$core$List$range, 0, barsCount - 1)));
	});
...
var $author$project$Resources$Font$subheadingFontSize = $author$project$Resources$Font$scaled(2);
var $author$project$Remote$view = F3(
	function (loaderView, successView, remoteData) {
		switch (remoteData.$) {
			case 'NotAsked':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Font$size($author$project$Resources$Font$subheadingFontSize)
							]),
						$mdgriffith$elm_ui$Element$text('No article is open'))
					]);
			case 'Loading':
				return _List_fromArray(
					[
...
var $mdgriffith$elm_markup$Mark$Error$Dark = {$: 'Dark'};
...
var $author$project$Article$viewErrors = function (errors) {
	return A2(
		$elm$core$List$map,
		A2(
			$elm$core$Basics$composeR,
			$mdgriffith$elm_markup$Mark$Error$toHtml($mdgriffith$elm_markup$Mark$Error$Dark),
...
var $author$project$Main$zeroSides = {bottom: 0, left: 0, right: 0, top: 0};
var $author$project$Main$layout = function (model) {
	var articleView = function (source) {
		var _v0 = A2($mdgriffith$elm_markup$Mark$compile, $author$project$Article$document, source);
		switch (_v0.$) {
			case 'Success':
				var article = _v0.a;
				return article;
			case 'Almost':
				...
				return _Utils_ap(
					result,
					$author$project$Article$viewErrors(errors));
			default:
				var errors = _v0.a;
				return $author$project$Article$viewErrors(errors);
		}
	};
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height(
				$mdgriffith$elm_ui$Element$px(model.windowSize.height)),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Resources$Color$backgroundColor)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Border$color($author$project$Resources$Color$borderColor),
						$mdgriffith$elm_ui$Element$Border$widthEach(
						_Utils_update(
							$author$project$Main$zeroSides,
							{bottom: 1}))
					]),
				_List_Nil),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$Background$color($author$project$Resources$Color$panelColor),
								$mdgriffith$elm_ui$Element$Border$color($author$project$Resources$Color$borderColor),
								$mdgriffith$elm_ui$Element$Border$widthEach(
								_Utils_update(
									$author$project$Main$zeroSides,
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
								A2($mdgriffith$elm_ui$Element$paddingXY, 200, 30),
								$mdgriffith$elm_ui$Element$spacing(20),
						...
						A3(
							...
							A2(
								$author$project$Loader$view,
								_Utils_update(
									$author$project$Loader$defaultConfig,
									{color: $author$project$Resources$Color$backgroundColor}),
								model.timeline),
							articleView,
							model.source))
					]))
...
var $author$project$Resources$Color$textColor = A3($mdgriffith$elm_ui$Element$rgb255, 192, 190, 196);
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$size($author$project$Resources$Font$bodyFontSize),
						$mdgriffith$elm_ui$Element$Font$family($author$project$Resources$Font$baseFont),
						$mdgriffith$elm_ui$Element$Font$color($author$project$Resources$Color$textColor)
					]),
